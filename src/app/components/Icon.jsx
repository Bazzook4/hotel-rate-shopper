...
/**
 * Line icons, drawn to a 24px grid and inheriting currentColor.
 *
 * Emoji were rendering at inconsistent sizes and weights across platforms
 * and could not take on the accent colour, so the navigation uses these
 * instead.
 */
const PATHS = {
  channel: (
  ...
  tag: (
    <>
      <path d="M12 2H7a2 2 0 0 0-2 2v5l9.5 9.5a2 2 0 0 0 2.8 0l4.2-4.2a2 2 0 0 0 0-2.8Z" />
